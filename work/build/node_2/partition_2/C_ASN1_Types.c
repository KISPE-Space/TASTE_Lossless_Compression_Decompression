...
#include "C_ASN1_Types.h"
...
#ifdef __NEED_CompressorDataBuffer_ACN

   int Encode_ACN_CompressorDataBuffer(void *pBuffer, size_t iMaxBufferSize, asn1SccCompressorDataBuffer *pSrc, int *errorCode)
   {
      int outErrorCode;
      STATIC BitStream strm;

      BitStream_Init(&strm, pBuffer, iMaxBufferSize);
      if (asn1SccCompressorDataBuffer_ACN_Encode(pSrc, &strm, &outErrorCode, TRUE) == FALSE) {
         if (errorCode != NULL) {
            *errorCode = outErrorCode;
         }
         #ifdef __unix__
            fprintf(stderr, "Could not encode CompressorDataBuffer (at %s, %d), errorCode was %d\\n", __FILE__, __LINE__, outErrorCode);
         #endif
         return -1;
      } else {
   ...
   int Decode_ACN_CompressorDataBuffer(asn1SccCompressorDataBuffer *pDst, void *pBuffer, size_t iBufferSize, int *errorCode)
   {
      int outErrorCode;
      STATIC BitStream strm;

      BitStream_AttachBuffer(&strm, pBuffer, iBufferSize);
      if(asn1SccCompressorDataBuffer_ACN_Decode(pDst, &strm, &outErrorCode)) {
         /* Decoding succeeded */
         return 0;
      } else {
         if(errorCode != NULL) {
         ...
         #ifdef __unix__
            fprintf(stderr, "Could not decode CompressorDataBuffer (at %s, %d), error code was %d\\n", __FILE__, __LINE__, outErrorCode);
         #endif
         return -1;
      }
   }
...
#ifdef __NEED_CompressorDataBuffer_UPER
   int Encode_UPER_CompressorDataBuffer(void *pBuffer, size_t iMaxBufferSize, const asn1SccCompressorDataBuffer *pSrc, int *errorCode)
   {
      int outErrorCode;
      STATIC BitStream strm;

      BitStream_Init(&strm, pBuffer, iMaxBufferSize);
      if (asn1SccCompressorDataBuffer_Encode(pSrc, &strm, &outErrorCode, TRUE) == FALSE) {
         if (errorCode != NULL) {
            *errorCode = outErrorCode;
         }
         #ifdef __unix__
   ...
   int Decode_UPER_CompressorDataBuffer(asn1SccCompressorDataBuffer *pDst, void *pBuffer, size_t iBufferSize, int *errorCode)
   {
      int outErrorCode;
      STATIC BitStream strm;

      BitStream_AttachBuffer(&strm, pBuffer, iBufferSize);
      if(asn1SccCompressorDataBuffer_Decode(pDst, &strm, &outErrorCode)) {
         /* Decoding succeeded */
         return 0;
      } else {
         if(errorCode != NULL) {
...
#endif
#ifdef __NEED_CompressorState_ACN

   int Encode_ACN_CompressorState(void *pBuffer, size_t iMaxBufferSize, asn1SccCompressorState *pSrc, int *errorCode)
   {
      int outErrorCode;
      STATIC BitStream strm;

      BitStream_Init(&strm, pBuffer, iMaxBufferSize);
      if (asn1SccCompressorState_ACN_Encode(pSrc, &strm, &outErrorCode, TRUE) == FALSE) {
         if (errorCode != NULL) {
            *errorCode = outErrorCode;
         }
         #ifdef __unix__
            fprintf(stderr, "Could not encode CompressorState (at %s, %d), errorCode was %d\\n", __FILE__, __LINE__, outErrorCode);
         #endif
         return -1;
      } else {
         return BitStream_GetLength(&strm);
   ...
   int Decode_ACN_CompressorState(asn1SccCompressorState *pDst, void *pBuffer, size_t iBufferSize, int *errorCode)
   {
      int outErrorCode;
      STATIC BitStream strm;

      BitStream_AttachBuffer(&strm, pBuffer, iBufferSize);
      if(asn1SccCompressorState_ACN_Decode(pDst, &strm, &outErrorCode)) {
         /* Decoding succeeded */
         return 0;
      } else {
         if(errorCode != NULL) {
         ...
         #ifdef __unix__
            fprintf(stderr, "Could not decode CompressorState (at %s, %d), error code was %d\\n", __FILE__, __LINE__, outErrorCode);
         #endif
         return -1;
      }
   }
...
#ifdef __NEED_CompressorState_UPER
   int Encode_UPER_CompressorState(void *pBuffer, size_t iMaxBufferSize, const asn1SccCompressorState *pSrc, int *errorCode)
   {
      int outErrorCode;
      STATIC BitStream strm;

      BitStream_Init(&strm, pBuffer, iMaxBufferSize);
      if (asn1SccCompressorState_Encode(pSrc, &strm, &outErrorCode, TRUE) == FALSE) {
         if (errorCode != NULL) {
            *errorCode = outErrorCode;
         }
         #ifdef __unix__
   ...
   int Decode_UPER_CompressorState(asn1SccCompressorState *pDst, void *pBuffer, size_t iBufferSize, int *errorCode)
   {
      int outErrorCode;
      STATIC BitStream strm;

      BitStream_AttachBuffer(&strm, pBuffer, iBufferSize);
      if(asn1SccCompressorState_Decode(pDst, &strm, &outErrorCode)) {
         /* Decoding succeeded */
         return 0;
      } else {
         if(errorCode != NULL) {
   ...
   int Encode_ACN_MyInteger(void *pBuffer, size_t iMaxBufferSize, asn1SccMyInteger *pSrc, int *errorCode)
   {
      int outErrorCode;
      STATIC BitStream strm;

      BitStream_Init(&strm, pBuffer, iMaxBufferSize);
      if (asn1SccMyInteger_ACN_Encode(pSrc, &strm, &outErrorCode, TRUE) == FALSE) {
         if (errorCode != NULL) {
            *errorCode = outErrorCode;
         }
         #ifdef __unix__
   ...
   int Decode_ACN_MyInteger(asn1SccMyInteger *pDst, void *pBuffer, size_t iBufferSize, int *errorCode)
   {
      int outErrorCode;
      STATIC BitStream strm;

      BitStream_AttachBuffer(&strm, pBuffer, iBufferSize);
      if(asn1SccMyInteger_ACN_Decode(pDst, &strm, &outErrorCode)) {
         /* Decoding succeeded */
         return 0;
      } else {
         if(errorCode != NULL) {
   ...
   int Encode_UPER_MyInteger(void *pBuffer, size_t iMaxBufferSize, const asn1SccMyInteger *pSrc, int *errorCode)
   {
      int outErrorCode;
      STATIC BitStream strm;

      BitStream_Init(&strm, pBuffer, iMaxBufferSize);
      if (asn1SccMyInteger_Encode(pSrc, &strm, &outErrorCode, TRUE) == FALSE) {
         if (errorCode != NULL) {
            *errorCode = outErrorCode;
         }
         #ifdef __unix__
   ...
   int Decode_UPER_MyInteger(asn1SccMyInteger *pDst, void *pBuffer, size_t iBufferSize, int *errorCode)
   {
      int outErrorCode;
      STATIC BitStream strm;

      BitStream_AttachBuffer(&strm, pBuffer, iBufferSize);
      if(asn1SccMyInteger_Decode(pDst, &strm, &outErrorCode)) {
         /* Decoding succeeded */
         return 0;
      } else {
         if(errorCode != NULL) {
