...
void deliver_to_uartotherend_samrh71tx(
        const asn1SccPID sender_pid, const uint8_t* const data, const size_t length);

// Sporadic provided
void deliver_to_testcompressuncompress_runonce(const asn1SccPID sender_pid, const uint8_t* const data, const size_t length);
