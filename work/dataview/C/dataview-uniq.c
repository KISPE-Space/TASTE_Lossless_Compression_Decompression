...
#ifdef __cplusplus
const asn1SccMyInteger asn1SccMyInteger_constant = 0UL;
#endif
...
void asn1SccMyInteger_Initialize(asn1SccMyInteger* pVal)
{
	...
	(*(pVal)) = (asn1SccMyInteger)asn1SccMyInteger_constant;
}
...
{
	return memcmp(pVal1->arr, pVal2->arr, 32) ==0;
...
#ifdef __cplusplus
const asn1SccCompressorDataBuffer asn1SccCompressorDataBuffer_constant = {.arr  = {[0 ... 32-1] = 0 }};
#endif
...
void asn1SccCompressorDataBuffer_Initialize(asn1SccCompressorDataBuffer* pVal)
{
	...
	(*(pVal)) = (asn1SccCompressorDataBuffer)asn1SccCompressorDataBuffer_constant;
}
...
flag asn1SccCompressorDataBuffer_Encode(const asn1SccCompressorDataBuffer* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	ret = bCheckConstraints ? asn1SccCompressorDataBuffer_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret && *pErrCode == 0) {
	    ret = BitStream_EncodeOctetString_no_length(pBitStrm, pVal->arr, 32);
    } /*COVERAGE_IGNORE*/
...
flag asn1SccCompressorDataBuffer_Decode(asn1SccCompressorDataBuffer* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	ret = BitStream_DecodeOctetString_no_length(pBitStrm, pVal->arr, 32);

	return ret  && asn1SccCompressorDataBuffer_IsConstraintValid(pVal, pErrCode);
}
...
{
    flag ret = TRUE;
    ret = ((((((((((((*(pVal)) == CompressorState_compressor_not_initialized)) || (((*(pVal)) == CompressorState_compressor_idle)))) || (((*(pVal)) == CompressorState_compressor_writing_data)))) || (((*(pVal)) == CompressorState_compressor_working)))) || (((*(pVal)) == CompressorState_compressor_success)))) || (((*(pVal)) == CompressorState_compressor_fail)));
    *pErrCode = ret ? 0 :  ERR_COMPRESSORSTATE;

	return ret;
}

#ifdef __cplusplus
const asn1SccCompressorState asn1SccCompressorState_constant = CompressorState_compressor_not_initialized;
#endif
...
void asn1SccCompressorState_Initialize(asn1SccCompressorState* pVal)
{
	...
	(*(pVal)) = (asn1SccCompressorState)asn1SccCompressorState_constant;
}
...
flag asn1SccCompressorState_Encode(const asn1SccCompressorState* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	ret = bCheckConstraints ? asn1SccCompressorState_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret && *pErrCode == 0) {
	    switch((*(pVal)))
	    {
	        case CompressorState_compressor_not_initialized:
	            BitStream_EncodeConstraintWholeNumber(pBitStrm, 0, 0, 5);
	        	break;
	        case CompressorState_compressor_idle:
	            BitStream_EncodeConstraintWholeNumber(pBitStrm, 1, 0, 5);
	        	break;
	        case CompressorState_compressor_writing_data:
	            BitStream_EncodeConstraintWholeNumber(pBitStrm, 2, 0, 5);
	        	break;
	        case CompressorState_compressor_working:
	            BitStream_EncodeConstraintWholeNumber(pBitStrm, 3, 0, 5);
	        	break;
	        case CompressorState_compressor_success:
	            BitStream_EncodeConstraintWholeNumber(pBitStrm, 4, 0, 5);
	        	break;
	        case CompressorState_compressor_fail:
	            BitStream_EncodeConstraintWholeNumber(pBitStrm, 5, 0, 5);
	        	break;
	        default:                    /*COVERAGE_IGNORE*/
	    	    *pErrCode = ERR_UPER_ENCODE_COMPRESSORSTATE; /*COVERAGE_IGNORE*/
...
flag asn1SccCompressorState_Decode(asn1SccCompressorState* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
...

	{
	    ...
	    *pErrCode = ret ? 0 : ERR_UPER_DECODE_COMPRESSORSTATE;
	    if (ret) {
	        switch(enumIndex)
	        {
	            case 0:
	                (*(pVal)) = CompressorState_compressor_not_initialized;
	                break;
	            case 1:
	                (*(pVal)) = CompressorState_compressor_idle;
	                break;
	            case 2:
	                (*(pVal)) = CompressorState_compressor_writing_data;
	                break;
	            case 3:
	                (*(pVal)) = CompressorState_compressor_working;
	                break;
	            case 4:
	                (*(pVal)) = CompressorState_compressor_success;
	                break;
	            case 5:
	                (*(pVal)) = CompressorState_compressor_fail;
	                break;
	            default:                        /*COVERAGE_IGNORE*/
		            *pErrCode = ERR_UPER_DECODE_COMPRESSORSTATE;     /*COVERAGE_IGNORE*/
		            ret = FALSE;                /*COVERAGE_IGNORE*/
	        }
	    } else {
	        (*(pVal)) = CompressorState_compressor_not_initialized;             /*COVERAGE_IGNORE*/
	    }
	}

	return ret  && asn1SccCompressorState_IsConstraintValid(pVal, pErrCode);
}
    ...
    *pErrCode = 0;
	...
	if (ret && *pErrCode == 0) {
	    switch((*(pVal))) {
	        ...
	        default:                                    /*COVERAGE_IGNORE*/
	            ret = FALSE;                            /*COVERAGE_IGNORE*/
	            *pErrCode = ERR_ACN_ENCODE_COMPRESSORSTATE;                 /*COVERAGE_IGNORE*/
	    }
	    if (ret) {
...
flag asn1SccCompressorState_ACN_Decode(asn1SccCompressorState* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = ret ? 0 : ERR_ACN_DECODE_COMPRESSORSTATE;
	if (ret) {
	    switch (intVal_pVal) {
	        case 0:
	            (*(pVal)) = CompressorState_compressor_not_initialized;
	    ...
	    default:                                    /*COVERAGE_IGNORE*/
	        ret = FALSE;                            /*COVERAGE_IGNORE*/
	        *pErrCode = ERR_ACN_DECODE_COMPRESSORSTATE;                 /*COVERAGE_IGNORE*/
	    }
	} /*COVERAGE_IGNORE*/
...
{
    flag ret = TRUE;
    ret = ((((((((((*(pVal)) == PID_datacompressor)) || (((*(pVal)) == PID_datauncompressor)))) || (((*(pVal)) == PID_testcompressuncompress)))) || (((*(pVal)) == PID_uartotherend)))) || (((*(pVal)) == PID_env)));
...
#ifdef __cplusplus
const asn1SccPID asn1SccPID_constant = PID_datacompressor;
#endif
...

	{
	    ...
	    *pErrCode = ret ? 0 : ERR_UPER_DECODE_PID;
	    if (ret) {
	        ...
	        {
	            case 0:
	                (*(pVal)) = PID_datacompressor;
	                break;
	            case 1:
	                (*(pVal)) = PID_datauncompressor;
	                break;
	            case 2:
	                (*(pVal)) = PID_testcompressuncompress;
	                break;
	            case 3:
	        ...
	        (*(pVal)) = PID_datacompressor;             /*COVERAGE_IGNORE*/
	    }
	}
